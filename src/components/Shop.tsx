      ...
      <div className="container mx-auto max-w-7xl relative">
        ...
        <div className={`mb-12 ${visibleAllOutfits.length ? '' : 'hidden'}`}>
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <h3 className="pl-1 text-2xl font-bold text-gray-800">
            ...
            <div className="w-full sm:w-auto">
              <select
                ...
                className="w-full rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-800 shadow-sm transition-colors duration-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-slate-400 sm:min-w-44"
              >
